...
| (d) | memory sprint state handoff | `C:\\Users\\hd\\.Codex\\projects\\D--quantmind-v2\\memory\\project_sprint_state.md` (铁律 37) | sub-PR cite + main HEAD pre/post + sediment cite + LL/ADR candidate sediment status + 红线 5/5 sustained verify |
