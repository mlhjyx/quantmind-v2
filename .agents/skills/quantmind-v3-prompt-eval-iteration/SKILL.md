...
| skill | scope |
|---|---|
| `quantmind-v3-prompt-design-laws` (batch 2 PR #273 sediment) | prompt 写出前 0 hardcoded 4 类决议 (Codex.ai vs CC 跨 system 沟通 prompt 设计) — sustained Constitution §L6.2 prompt-design-laws 决议 |
