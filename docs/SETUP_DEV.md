...
- `QM_DB_PASSWORD` (新, PR #387-#389 sediment): 8 ops/research script 共享 DB 密码, 与 DATABASE_URL 内嵌 password 一致. fallback `"quantmind"` 仍在 source 作 partial closure (铁律 35). 详 `docs/audit/H1_FAMILY_CLOSURE_STATUS_REPORT_2026_05_20.md`.
