...
>
> **本文件版本**: v0.7 (post-V3 §S2.5 architecture sediment + RSSHub route reuse decision + auto mode reasonable defaults 1st sediment 实证, 2026-05-09, sub-PR 11a V3 §S2.5 architecture sediment + DDL sediment + ADR-049 + LL-139 sediment, 沿用 ADR-022 反 silent overwrite — v0.1-v0.6 row 保留 + version history append)
