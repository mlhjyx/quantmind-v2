...
>
> **本文件版本**: v0.6 (post-V3 §S2 closure verify + V2 prior cumulative cite sediment, 2026-05-09, sub-PR 10 V3 §S2 closure acceptance + 4/4 RSSHub capacity expansion deferred to S5, 沿用 ADR-022 反 silent overwrite — v0.1/v0.2/v0.3/v0.4/v0.5 row 保留 + version history append)
