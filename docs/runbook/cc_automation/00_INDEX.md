...
| 03 | [`03_ollama_install_runbook.md`](03_ollama_install_runbook.md) | Ollama D 盘 install (`D:\Program Files\Ollama` + `D:\ollama-models`) + `ollama pull qwen3:8b` (5.2 GB), 启用 BudgetAwareRouter Capped100 fallback path — S3 PR #225 sediment | 0 (LLM fallback 路径 0 broker call + 本地 Ollama 0 对外暴露 + LIVE_TRADING_DISABLED 沿用) |
