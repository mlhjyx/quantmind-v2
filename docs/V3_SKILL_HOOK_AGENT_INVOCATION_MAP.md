...
>
> **本文件版本**: v0.3 (post-Tier A plan 修订 sediment, 2026-05-09, V3 governance batch closure sub-PR 8 — Finding #2 (b) S2.5 row 加 + Push back #3 (b) parallel S2 sediment, 沿用 ADR-022 反 silent overwrite — v0.1/v0.2 row 保留 + version history append)
