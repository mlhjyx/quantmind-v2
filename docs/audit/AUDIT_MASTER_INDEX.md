...
| **合计** | **22** | **13** | **10** | **9** | **54** | **31** | **23** |

> S1 静态广扫 + S1 cleanup pass + S2 一致性专项（静态 + 4 快修）+ S4 动态基线验证 + S3 韧性静态审计 + **S2b factor_onboarding 彻底重构** + **Phase B M1-M3 (F86/F75/F45)** + **Phase C C0-C3 (F31)** + **Phase D D1+D2 (IC 路径统一 + F16)** 已完成。counter 维度的 "P0 未处理" 持续为 0. 看板维度: F31 ✅ (Phase C) + F16 ✅ (Phase D D2), **看板 ⬜ 剩 1 条 F63** (前端 API 契约缺口, Phase D D3 处理).
