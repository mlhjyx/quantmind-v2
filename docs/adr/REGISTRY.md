...
## 状态分布 (5-08 chunk C-ADR 修订, post-PR #265 + 本 PR)

- **committed ( file 在 docs/adr/)**: 33 个 (ADR-001~014 + ADR-010-addendum + ADR-021/022/023/024/027/028/031/032/033/034/035/036/037/039/**040**/**041**/**042**/043) — 本 PR +ADR-040/041/042 (ADR-DRAFT row 8/9/10 promote → committed)
- **reserved (V3 §18.1 待办, 0 file 等起手时 sediment)**: 6 个 (ADR-019/020/025/026/029/030) — 本 PR -ADR-040/041/042 (promote → committed)
- **gap (0 file, 0 reserve)**: 4 个 (ADR-015/016/017/018, 历史跳号)

总 43 # space (含 gap), 活跃 39 (committed 33 + reserved 6). **跳号 ADR-038** (LiteLLM cost registry V4 gap reserve, ADR-DRAFT row 6 promote target, 等 LiteLLM SDK 升级 verify 时 sediment).
