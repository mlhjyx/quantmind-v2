...
- **测试基线** (iter 231 fresh verify 2026-05-26, 铁律 40 baseline 保持): **6869 collected / 0 collection error** (vs iter 80 baseline 6714 = +155 / +2.3% Wave 5 iter 196-216 ~55 unit tests cumulative + sibling additions; vs 5-20 实测 6251 = +618 / +9.9%; vs Session 9 实测 2864 pass / 24 fail, ~1.5 月增量 +4005 tests / +140%) + **fail baseline 2 fail sustained** (no new fails added in iter 196-231 Wave 5 + post-Wave-5 work — 8+ month low-fail state maintained; 残 2 fail: test_factor_determinism flaky-in-sweep + 1 unknown sweep) + **smoke 91 PASS** (iter 189 pre-push hook scope broadened backend/tests/smoke/ → backend/tests/, +30 smoke-marked tests previously ungated; sustained pre-push hook green iter 189-231 cumulative ~40 push cycles) + regression 5yr+12yr max_diff=0 (baseline 2026-04-28 stale, 待 Phase B-2 refresh)
