...
- ⬜ **Wave 2 剩余** (~1 周): **MVP 2.3 Sub2** (批 2/3 research scripts 20+ 全量迁 SDK, 现 Sub3 C1+C4 硬依赖已兑现 — 每 script 可直接 `PlatformBacktestConfig()` 无 builder hack)
