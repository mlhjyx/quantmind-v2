...
环境: Windows 11 Pro (R9-9900X 3D + RTX 5070 12GB + 32GB DDR5), PG: D:\pgdata16, 用户: xin
...
## 资源约束（Windows 11 Pro / AMD R9-9900X 3D 8C/16T / RTX 5070 12GB / 32GB DDR5-6000 / 2TB NVMe）
...
- **用户**: 1人使用，全职投入
- **月预算**: ≤¥500
- **硬件**: Windows 11 Pro (AMD R9-9900X 3D 8C/16T + RTX 5070 12GB VANGUARD SOC + 32GB DDR5-6000 → 后期64GB + 2TB NVMe)
...
- 基线Sharpe：1.019（Windows环境，2021-2025全期，因reversal_20在2021-01缺失较Mac的1.037低0.018）
- 基线MDD：-39.7%
